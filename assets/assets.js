...
import casio from "./watchBrands/casio.png"
import longines from "./watchBrands/longines.png"
import omega from "./watchBrands/omega.png"
import rado from "./watchBrands/rado.png"
import rolex from "./watchBrands/rolex.png"
import seiko from "./watchBrands/seiko.png"
import tissot from "./watchBrands/tissot.png"
...
export const categories = ["casio","longines",
"omega",
"rado",
"rolex",
"seiko",
...
export const dummyStoreData = {
    ...
    userId: "user_1",
    name: "Casio",
    description: "At Casio, we believe shopping should be simple, smart, and satisfying. Whether you're hunting for the latest fashion trends, top-notch electronics, home essentials, or unique lifestyle products — we've got it all under one digital roof.",
    username: "casio",
    address: "3rd Floor, Casio , New Building, 123 street , c sector , NY, US",
    status: "approved",
    isActive: true,
    logo: 'https://logos-world.net/wp-content/uploads/2023/03/Casio-Logo.jpg',
